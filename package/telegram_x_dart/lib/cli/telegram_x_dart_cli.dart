...
import 'package:telegram_x_dart/api/telegram_x_dart_api_core.dart';
import 'package:universal_io/io.dart';

Logger logger = Logger();

Future<void> packageFullTemplateDartCli(List<String> args_raw) async {
  TelegramXDartApi packageFullTemplateDartApi = TelegramXDartApi();
  ...
  TelegramXDartBuildType server_universeDartBuildType = TelegramXDartBuildType.release;

  if (args.contains("--debug")) {
    server_universeDartBuildType = TelegramXDartBuildType.debug;
  }
